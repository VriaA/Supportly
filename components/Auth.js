...
export default function Auth() {
    const { isSignIn, isSignUp, isDeleteAccount, authError, loading, updateUserDataOnChange, authenticateWithGoogle, authenticateWithEmailAndPassword } = useAuth()
    ...
    return (
        <Box className="flex justify-center items-center min-h-[100svh] max-w-[1536px] py-[10svh] md:py-[5svh] bg-[url(../public/images/auth_bg.png)] bg-cover bg-left bg-no-repeat">
                    ...
                    <div className="flex flex-col gap-3 md:gap-2 justify-between items-center w-full mt-8 pt-8 border-t border-t-[#afafb6]">
                        {!isDeleteAccount && (
                            <p className="w-full h-10 text-base font-medium text-zinc-900 bg-zinc-200 hover:text-zinc-200 hover:bg-zinc-900 rounded-xl">
                                <Link className="flex justify-center items-center w-full h-full"
