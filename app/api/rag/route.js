...
const endpoint =
  "https://ap-south-1.aws.data.mongodb-api.com/app/data-arspkyb/endpoint/data/v1/action";
const headers = {
...
async function fetchEmbeddings(query) {
  ...
  const response = await fetch(
    `https://Anushka12.pythonanywhere.com/chatbot?query=${encodeURIComponent(query)}`,
  );
